  ...
  return (
    <>
      <motion.nav
        ...
        className='w-full fixed top-0 flex justify-between items-center px-28 py-5 bg-white z-100 shadow-md max-sm:px-5'
      >
          ...
          <div className="nav-options flex justify-between items-center w-3/5 max-sm:hidden">
