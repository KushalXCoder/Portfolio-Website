        ...
        <div className="flex flex-col px-20 w-full font-display items-center max-sm:px-5">
            ...
            <div className="projects-container flex flex-col">
              <motion.div
                ...
                className="project-1 flex my-10 relative max-sm:flex-col max-sm:items-center"
              >
              ...
              >
                ...
                <img src={Project2} alt="Project1 Image" className='w-2/4 rounded-md max-sm:w-full'/>
              </motion.div>
              <motion.div
                initial={{x: -100, opacity: 0}}
                whileInView={{x: 0, opacity: 1, transition: {duration: 1}}}
                ...
                className="project-1 flex my-10 relative max-sm:flex-col max-sm:items-center"
              >
                <img src={Project3} alt="Project1 Image" className='w-2/4 rounded-md border-2 border-white max-sm:w-full'/>
                <div className="project-1-content flex flex-col ps-20 max-sm:ps-0 max-sm:mt-10">
