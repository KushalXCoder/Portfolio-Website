            ...
            <div className="bottom-content w-full flex max-sm:flex-col">
                ...
                <div className="right-container w-[50%] flex flex-col max-sm:w-full max-sm:mt-10">
                    <motion.h1
                        ...
                        viewport={{once: true, amount: 0.5}} className='text-4xl'
                    >
                        About <span className='font-bold bg-yellow-300 px-2 rounded-md'>Me</span>
                    </motion.h1>
                    <motion.div
                        initial={{x: -50, opacity: 0}}
                        whileInView={{x: 0, opacity: 1, transition: {duration: 1}}}
                        viewport={{once: true, amount: 0.3}}
                        className="about-me-para w-full text-lg flex flex-col gap-6 mt-12 *:text-gray-500 overflow-x-hidden max-sm:mt-6"
                    >
