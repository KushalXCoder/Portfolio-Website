...
const Footer = () => {
  return (
    <motion.footer
      ...
      className='footer-container w-full bg-black px-28 py-8 flex font-display justify-between items-center max-sm:px-5'
    >
        <motion.h1 className='text-white text-4xl font-bold cursor-pointer max-sm:text-2xl' whileHover={{rotate: "-4deg"}}>Kushal Rathod</motion.h1>
